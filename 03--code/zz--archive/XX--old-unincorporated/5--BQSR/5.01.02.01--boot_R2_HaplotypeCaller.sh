...
# JOB DESCRIPTION
################################################################################
# Use GATK HaplotypeCaller to call a 2nd round of raw germline variants for bootstrapping when no dbSNP known variant sites file is available for organism
...
--input="$IN_RECAL1_BAM" \
--output="$SAMPLE_ID"_bootRawGermVar_R2.vcf \
