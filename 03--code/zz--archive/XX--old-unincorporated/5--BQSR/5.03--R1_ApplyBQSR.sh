...
# JOB DESCRIPTION
################################################################################
# Uses GATK ApplyBQSR to take a recalibration table (made from HaplotypeCaller) and recalibrate original clean, but raw, BAM files to correct for systematic sequencing biases in base quality scores
...
-O="$OUT_RECAL_BAM_HEADER".BQSR_R1.recal.bam \
-TMP_DIR=$TMPDIR
