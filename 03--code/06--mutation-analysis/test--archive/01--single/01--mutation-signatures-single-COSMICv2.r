...
# title: mutational signature analysis - single - COSMIC signatures v2
# author: Leo Williams
# date: 2019-07-02
...
# Analysis ----------------------------------------------------------------
    ...
    # 3) Mutation characteristics ---------------------------------------------
        ...
        # Plot the mean relative contribution of each of the 6 base substitution types for this sample
    ...
    # 4) Mutational signatures ------------------------------------------------
        ...
        cancer_signatures = read.csv(file = "/Users/leo/Documents/documents-Leo/02--work--career/lab--Pursell/03--projects--Pursell-lab/project_002--DNA-seq-analysis-of-mouse-POLE-exo-mutant-tumor-data/02--data/02--reference-data/COMIC-mutation-signatures/COSMIC-mutation-signatures-v2.csv", header = T)
